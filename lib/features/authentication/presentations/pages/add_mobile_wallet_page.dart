...
class AddMobileWalletPage extends StatefulWidget {
  final WalletModel wallet;
  const AddMobileWalletPage({super.key, required this.wallet});

  @override
  State<AddMobileWalletPage> createState() => _AddMobileWalletPageState();
}

class _AddMobileWalletPageState extends State<AddMobileWalletPage> {
